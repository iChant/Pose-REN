from src.Grad.GestureLearningDialog.ui_gesturelearning import Ui_GestureLearningDialog
...
class GestureLearningDialog(QDialog, Ui_GestureLearningDialog):
    def __init__(self, parent=None):
        super(GestureLearningDialog, self).__init__(parent=parent)
        self.setupUi(self)
